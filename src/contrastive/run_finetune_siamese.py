    ...
    if training_args.do_train:
        ...
        if training_args.load_best_model_at_end:
            ...
            if data_args.dataset_name == 'lspc':
                swc_test_dataset = ContrastiveClassificationDataset(raw_datasets["test"].replace('preprocessed_computers_gs.pkl.gz', 'preprocessed_computers_new_testset_1500.pkl.gz'), dataset_type='test', size=data_args.train_size, tokenizer=model_args.tokenizer, dataset=data_args.dataset_name)
