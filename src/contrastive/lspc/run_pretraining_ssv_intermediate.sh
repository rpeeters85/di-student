...
python run_pretraining_ssv.py \
    ...
    --output_dir /pfs/work7/workspace/scratch/ma_rpeeters-ma_rpeeters-0/phd/dev/di-research/reports/contrastive/computers-ssv-$SIZE-$AUG$BATCH-$LR-$TEMP-$INTERM-${MODEL##*/}/ \
	--temperature=$TEMP \
