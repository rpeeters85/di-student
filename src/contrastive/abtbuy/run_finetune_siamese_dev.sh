...
CUDA_VISIBLE_DEVICES=2 python run_finetune_siamese.py \
	--model_pretrained_checkpoint /work-ceph/rpeeters/phd/dev/di-research/reports/contrastive/dev-abtbuy-clean-$PREAUG$BATCH-$LR-$TEMP-${MODEL##*/}/pytorch_model.bin \
    --do_train \
    ...
    --output_dir /work-ceph/rpeeters/phd/dev/di-research/reports/contrastive-ft-siamese/dev-abtbuy-clean-$AUG$BATCH-$PREAUG$LR-$TEMP-$FROZEN-${MODEL##*/}/ \
