...
class MatrixModel(nn.Module):
    ...
    def __init__(self, len_tokenizer, model='huawei-noah/TinyBERT_General_4L_312D', pool=True, comb_fct='abs-diff'):
        super().__init__()
        ...
        self.matrix_head = MatrixModelHead(self.config, self.comb_fct)
    ...
    def forward(self, input_ids, attention_mask, labels, input_ids_right, attention_mask_right):
        ...
        logits, labels = self.matrix_head(output, labels)
