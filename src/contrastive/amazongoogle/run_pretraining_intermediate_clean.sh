...
python run_pretraining_deepmatcher.py \
    ...
    --output_dir /pfs/work7/workspace/scratch/ma_rpeeters-ma_rpeeters-0/phd/dev/di-research/reports/contrastive/amazongoogle-clean-$AUG$BATCH-$LR-$TEMP-$INTERM-${MODEL##*/}/ \
	--temperature=$TEMP \
