...
python run_finetune_siamese.py \
	--model_pretrained_checkpoint /pfs/work7/workspace/scratch/ma_rpeeters-ma_rpeeters-0/phd/dev/di-research/reports/contrastive/company-clean-$PREAUG$BATCH-$LR-$TEMP-$INTERM-${MODEL##*/}/pytorch_model.bin \
    --do_train \
    ...
    --output_dir /pfs/work7/workspace/scratch/ma_rpeeters-ma_rpeeters-0/phd/dev/di-research/reports/contrastive-ft-siamese/company-clean-$AUG$BATCH-$PREAUG$LR-$TEMP-$INTERM-$FROZEN-${MODEL##*/}/ \
